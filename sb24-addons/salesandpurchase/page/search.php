...
class page_salesandpurchase_page_search extends page_base_site {
	function init(){
		...
		$fields=array(
			...
			'search'=>array('type'=>'line','span'=>9,'caption'=>' ')
			);
		...
		$search_field=$form->getElement('search')->setAttr('placeholder','search in description and information')->addClass('leftmargin span9');
