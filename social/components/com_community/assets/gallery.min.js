...
if(c>0){jax.call("community","photos,ajaxAddPhotoTag",a.photoId,c,a.top,a.left,a.width,a.height);}joms.gallery.cancelNewPhotoTag();},removePhotoTag:function(a){jax.call("community","photos,ajaxRemovePhotoTag",a.photoId,a.userId);
...
if(tags.length==0){photoTextTags.html("");}if(typeof(tags)=="string"){tags=eval("("+tags+")");}var singleTag=false;if(!joms.jQuery.isArray(tags)){tags=[tags];
