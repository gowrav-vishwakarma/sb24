...
class CommunityViewGroups extends CommunityView
{
	...
	public function _addSubmenu()
	{
		...
		$task		=   $jinput->get->get('task' , ''); //Request::getVar( 'task' , '' , 'GET' );
		$config		= CFactory::getConfig();
	...
	**/
	...
	public function viewGroup($group)
	{
		...
		$editGroup		= $jinput->get->get('edit' , FALSE, 'NONE'); //JRequest::getVar( 'edit' , false , 'GET' );
	...
	public function viewbulletin( )
	{
		...
		$group			= JTable::getInstance( 'Group' , 'CTable' );
		$my				= CFactory::getUser();
		$bulletinId		= $jinput->get->get( 'bulletinid' , '' , 'INT');
