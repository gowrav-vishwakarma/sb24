...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		<tbody>
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_PHOTOS_GALLERY_SLIDER' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_PHOTOS_GALLERY_SLIDER_TIPS'); ?>">
