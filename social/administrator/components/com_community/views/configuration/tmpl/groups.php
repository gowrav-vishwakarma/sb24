			...
			<tr>
				...
				<td valign="top">
					<?php echo JHTML::_('select.booleanlist' , 'groupdiscussnotification' , null , $this->config->get('groupdiscussnotification') , JText::_('COM_COMMUNITY_YES_OPTION') , JText::_('COM_COMMUNITY_NO_OPTION') ); ?>
                         ...
                         <tr>
                                <td class="key">
                                    <span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_DISCUSSION_FILE_SHARING_LIMIT' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_DISCUSSION_FILE_SHARING_LIMIT_TIPS'); ?>">
...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
            <tbody>
                     <tr>
                                <td class="key">
                                    <span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_DISCUSSION_FILE_SHARING' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_DISCUSSION_FILE_SHARING_TIPS'); ?>">
					...
					<?php echo JHTML::_('select.booleanlist' , 'groupdiscussfilesharing' , null , $this->config->get('groupdiscussfilesharing') , JText::_('COM_COMMUNITY_YES_OPTION') , JText::_('COM_COMMUNITY_NO_OPTION') ); ?>
                      ...
                      <tr>
                                <td class="key">
                                    <span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_DISCUSSION_FILE_SHARING_MAX_SIZE' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_DISCUSSION_FILE_SHARING_MAX_SIZE_TIPS'); ?>">
...
<fieldset class="adminform">
    ...
    <table class="admintable" cellspacing="1">
        <tbody>
            <tr>
                <td class="key">
                    <span class="editlinktip hasTip" title="<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_BULLETIN_FILE_SHARING')?>::<?php echo Jtext::_('COM_COMMUNITY_CONFIGURATION_BULLETIN_FILE_SHARING_TIPS')?>">
