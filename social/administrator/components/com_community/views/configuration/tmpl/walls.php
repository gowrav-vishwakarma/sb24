		...
		<tbody>
			<tr>
				<td width="300" class="key">
					<span class="hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_EDIT_COMMENTS_ENABLE' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EDIT_COMMENTS_ENABLE_TIPS'); ?>">
