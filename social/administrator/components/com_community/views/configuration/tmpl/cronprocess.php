			...
			<tr>
				...
				<td valign="top">
					<?php echo JHTML::_('select.booleanlist' , 'sendemailonpageload' , null , $this->config->get('sendemailonpageload') , JText::_('COM_COMMUNITY_YES_OPTION') , JText::_('COM_COMMUNITY_NO_OPTION') ); ?>
                        ...
                        <tr>
				<td width="300" class="key">
					<span class="hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_CRONJOB_ARCHIVE_MAX_DAY' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_CRONJOB_ARCHIVE_MAX_DAY_TIPS'); ?>">
