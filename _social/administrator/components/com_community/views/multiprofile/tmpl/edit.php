			...
			<fieldset>
				...
				<table class="admintable" cellspacing="1">
					<tbody>
						...
						<tr>
							<td width="300" class="key" valign="top">
								<span class="hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_MULTIPROFILES_LOCK' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_MULTIPROFILES_LOCK_TIPS'); ?>"><?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_MULTIPROFILES_LOCK' ); ?></span>
							</td>
							<td valign="top">
