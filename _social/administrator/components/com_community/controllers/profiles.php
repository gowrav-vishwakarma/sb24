...
<table cellspacing="0" class="paramlist admintable" border="0" width="100%">
	<tbody>
		<tr>
			<td class="key"><?php echo JText::_('COM_COMMUNITY_NAME');?> <span class="required">*</span></td>
			<td>
		...
		<tr>
			<td class="key"><?php echo JText::_('COM_COMMUNITY_FIELD_CODE');?> <span class="required">*</span></td>
