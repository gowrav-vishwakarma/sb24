...
class CommunityViewVideos extends CommunityView
{
	...
	**/
	...
	public function video()
	{
		...
		$config		= CFactory::getConfig();
		$my		= CFactory::getUser();
		$videoId	= $jinput->get->get('videoid' , '' , 'INT'); //JRequest::getVar('videoid' , '' , 'GET');
		$groupId	= $jinput->get->get('groupid' , '' , 'INT'); //JRequest::getVar('groupid' , '' , 'GET');
		...
		$sorted 	=  $jinput->get('sort', 'latest', 'STRING'); // JRequest::getVar('sort', 'latest');
		$limit	=   $jinput->get('limitstart' , 6 , 'INT'); //JRequest::getVar( 'limitstart' , 6 );
		$permissions=   ($my->id==0) ? 0 : 20;
		$cat_id		=	 $jinput->get('cat_id', '', 'INT'); //JRequest::getVar('cat_id', '');
		$model		=	CFactory::getModel('videos');
		...
		//CFactory::load( 'libraries' , 'videotagging' );
